...
// This is my addition to the PureKnob library
// Audio knob code
const audio_knob = pureknob.createKnob(300, 300);
function create_knob() {
    if (document.querySelector('#control-knob').childNodes.length > 0){
       return; 
    }
    // Set properties
